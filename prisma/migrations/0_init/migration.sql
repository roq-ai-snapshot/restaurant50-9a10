...
-- AddForeignKey
ALTER TABLE "reservation" ADD CONSTRAINT "reservation_wait_staff_id_fkey" FOREIGN KEY ("wait_staff_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "restaurant" ADD CONSTRAINT "restaurant_manager_id_fkey" FOREIGN KEY ("manager_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
