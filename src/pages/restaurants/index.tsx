    ...
    () =>
      getRestaurants({
        relations: [
          ...
          'user_restaurant_manager_idTouser',
          'menu_item.count',
          'order.count',
          'reservation.count',
        ],
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                    <Th>user_restaurant_manager_idTouser</Th>
                  )}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/users/view/${record.user_restaurant_manager_idTouser?.id}`}>
                          {record.user_restaurant_manager_idTouser?.email}
                        </Link>
                      </Td>
                    )}
